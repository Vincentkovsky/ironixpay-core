...
interface NetworkMeta {
    mainnet: string;
    testnet: string;
    /** Token standard label (TRC20, BEP20, ERC20) */
...
/**
 * Convert raw network identifier + environment flag to a human-readable name.
 *
 * @example networkDisplayName('TRON', true)  // => 'TRON Nile'
 * @example networkDisplayName('BSC', false)  // => 'BSC Mainnet'
 */
...
/**
 * Get the token standard label for a network (e.g. TRC20, BEP20, ERC20).
 */
...
/**
 * True if the network is an EVM-compatible chain (i.e. not TRON).
 */
